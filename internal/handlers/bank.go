...
import (
	"encoding/json"
	"fmt"
	"github.com/gidyon/api-open-banking/internal/models/bank"
...
func addBankHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	...
	if err != nil {
		http.Error(w, "couldn't decode bank payload: "+err.Error(), http.StatusInternalServerError)
		return
	}
...
func getBanksHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	...
	if err != nil {
		http.Error(w, "failed to get user banks: "+err.Error(), http.StatusInternalServerError)
		return
	}
...
func getBankHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	...
	if err != nil {
		http.Error(w, "failed to get user bank: "+err.Error(), http.StatusInternalServerError)
		return
	}
